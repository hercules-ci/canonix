        ...
        '';
          ...
          extraPlugins =
            mkOption {
              ...
              default = [];
              example =
                literalExample "[ (pkgs.postgis.override { postgresql = pkgs.postgresql_9_4; }) ]";
              description =
                ''
        ...
        '';
          ...
          superUser =
            mkOption {
              type = types.str;
              default =
                if versionAtLeast config.system.stateVersion "17.09" then "postgres" else "root";
              internal = true;
              description =
                ''
          ...
          serviceConfig =
            {
              ...
              Type =
                if lib.versionAtLeast cfg.package.version "9.6"
                   then "notify"
                   else "simple";
